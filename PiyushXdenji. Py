...
os.system('clear')
requests.get(f"https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&video=https://t.me/aboutk3s63/10=>𝒀𝒐𝒖 𝒎𝒖𝒔𝒕 𝒋𝒐𝒊𝒏 https://t.me/k3s63cc 𝒔𝒐 𝒕𝒉𝒂𝒕 𝒕𝒉𝒆 𝒕𝒐𝒐𝒍 𝒓𝒖𝒏𝒔 𝒘𝒊𝒕𝒉𝒐𝒖𝒕 𝒑𝒓𝒐𝒃𝒍𝒆𝒎𝒔.\n> 𝑶𝒏𝒄𝒆 𝒚𝒐𝒖 𝒉𝒂𝒗𝒆 𝒋𝒐𝒊𝒏𝒆𝒅 𝒕𝒉𝒆 𝒄𝒉𝒂𝒏𝒏𝒆𝒍, 𝒆𝒏𝒋𝒐𝒚 𝒉𝒊𝒕𝒔 𝒂𝒏𝒅 𝒔𝒆𝒏𝒅 𝒔𝒄𝒓𝒆𝒆𝒏𝒔 𝒐𝒇 𝒉𝒊𝒕𝒔.&parse_mode=Markdown")
def cookie(email):
